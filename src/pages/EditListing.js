  ...
  () => {
    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
      resolve(downloadURL)
        ...
        const imageUrls= await Promise.all([...images].map((image)=>storeImage(image))).catch(()=>{setLoading(false)
        ...
        // we dont want to save img and address
        ...
        <main>
          ...
          <div className='formPriceDiv'>
            <input
              ...
              required
            />
            {type === 'rent' && <p className='formPriceText'>DT / Month</p>}
          </div>
